...
const Footer = ({ setPage }) => {
    ...
    const columns = [
        { heading: [`${spark} Shop`], links: ['All Products', 'Kitchen', 'Home', 'Garden',] },
        { heading: [`${spark} Company`], links: ['About Us', 'Journal', 'Blog', 'Press'] },
        { heading: [`${spark} Support`], links: ['FAQ', 'Shipping', 'Returns', 'Contact'] }
    ]

    const icons = [{ icon: faInstagram, link: "https://instagram.com" }, { icon: faFacebook, link: "https://facebook.com" }, { icon: faXTwitter, link: "https://twitter.com" }];
        ...
        <footer className="footer">
            <div className="footer_inner">
                <div className="footer_brand">
                    ...
                    <p className="footer_tagline">Your one-stop shop for all your needs</p>

                    <div className="footer_socials">
                        {icons.map((iconn) => (
                            <a key={iconn.link} href={iconn.link} className="footer_social-btn" target="_blank" rel="noopener noreferrer">
                                <FontAwesomeIcon icon={iconn.icon} />
                            </a>
                        ))}
                    </div>

                    <p className="footer-text">&copy; 2026 Shoppingcart. All rights reserved.</p>
                </div>
                    ...
                    <div key={col.heading} className="footer_col">
                        ...
                        <p className="footer_col-links">
                            ...
                            {col.links.map((link) => (
                                ...
                                <button key={link} className="footer_link-but" onClick={() => setPage('shop')}>
                                    {link}
                                </button>
                            ))}
